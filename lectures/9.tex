...
\]
The purpose of the regularizer is to add a penalty to shrink a coefficient, or in other words, to minimize the loss function. This can be helpful for loss functions like square loss as it is sensitive to outliers and can compute unexpectedly large coefficients.
